...
class Team(db.Model):
  ...
  v_scorecards = db.relationship('Scorecard', foreign_keys='Scorecard.home_team_id', backref='team', lazy='dynamic')
  h_scorecards = db.relationship('Scorecard', foreign_keys='Scorecard.visitor_team_id', backref='team', lazy='dynamic')
